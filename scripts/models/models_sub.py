...
from models.layers_sub import ConvBlock, ConvBlockRemoveWeightNorm, LinearBlock, LinearBlockRemoveWeightNorm
...
class GraspModel(nn.Module):
    def __init__(self, in_channels):
      ...
      self.conv_block_r7 = ConvBlockRemoveWeightNorm(in_channels = 48, out_channels = 4, kernel_size = 1)
      ...
      self.conv_block_z7 = ConvBlock(in_channels = 128, out_channels = 48, kernel_size = 1)
...
class PlaceModel(nn.Module):
    def __init__(self, in_channels):
      ...
      self.conv_block_r11 = ConvBlockRemoveWeightNorm(in_channels = 48, out_channels = 1, kernel_size = 1)
      ...
      self.conv_block_z11 = ConvBlock(in_channels = 128, out_channels = 48, kernel_size = 1)
    ...
    def forward(self, inputs1, inputs2):
      ...
      reward = self.conv_block_r11(x_r)
      reward = self.sigmoid(reward)
...
class MergeModel(nn.Module):
    def __init__(self, in_features):
      ...
      self.linear_block4 = LinearBlockRemoveWeightNorm(in_features = 64, out_features = 1)
