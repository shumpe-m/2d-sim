...
class Heatmap:
   ...
   def render(
      ...
      base = image
      image_grasp = self.inf.get_images(image)
      input_images = torch.tensor(image_grasp)
...
if __name__ == '__main__':
   ...
   image_grasp = cv2.imread("./data/img/depth_grasp2117.png", cv2.IMREAD_GRAYSCALE)
   # image_place = cv2.imread("./data/img/depth_place_b2117.png", cv2.IMREAD_GRAYSCALE)
   # image_goal = cv2.imread("./data/img/depth_goal2117.png", cv2.IMREAD_GRAYSCALE)
